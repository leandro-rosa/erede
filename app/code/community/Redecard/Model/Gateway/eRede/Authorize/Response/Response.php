 ...
 */
class LeandroRosa_Redecard_Model_Gateway_eRede_Authorize_Response_Response
    extends Varien_Object
{
    ...
    {
        return $this->getData(static::AMOUNT);
    }
    ...
    {
        return $this->getData(static::LAST4);
    }

    /**
     * @return LeandroRosa_Redecard_Model_Gateway_eRede_Authorize_Response_ThreeDSecure
     */
    public function getThreeDSecure()
    {
        $threeDSecure = ($this->getData(static::THREE_D_SECURE)) ?: [];
        return new LeandroRosa_Redecard_Model_Gateway_eRede_Authorize_Response_ThreeDSecure($threeDSecure);
    }
    ...
    {
        $this->setData(static::LAST4, $value);
        return $this;
    }
     ...
     * @return $this
     */
    public function setThreeDSecure(array $value)
    {
        $this->setData(static::THREE_D_SECURE, $value);
        return $this;
    }
}
